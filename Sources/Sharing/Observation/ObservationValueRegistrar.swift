...
public struct ObservationValueRegistrar: Sendable {
  public private(set) var id = ObservableValueID()
  #if !os(visionOS)
    @usableFromInline
...
extension ObservationValueRegistrar: Equatable, Hashable, Codable {
  ...
  extension ObservationValueRegistrar {
    ...
    @inlinable
    public func willModify<Subject: Observable, Member: ObservableValue>(
      _ subject: Subject,
      keyPath: KeyPath<Subject, Member>,
      _ member: inout Member
    ) -> Member {
  ...
  extension ObservationValueRegistrar {
    ...
    @_disfavoredOverload
    @inlinable
    public func willModify<Subject: Perceptible, Member: ObservableValue>(
      _ subject: Subject,
      keyPath: KeyPath<Subject, Member>,
      _ member: inout Member
    ) -> Member {
